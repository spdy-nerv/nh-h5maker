...
const setAddedElementToEdit = (commit, state) => {
...
export const addElement = ({commit, state}, data) => {
  commit(types.ADD_PIC_ELEMENT, new Element(data))
	setAddedElementToEdit(commit, state);
}

/**
 * 添加标题控件
 */
export const addTitleElement = ({commit, state}, data) => {
	commit(types.ADD_ELEMENT, new Title(data))
	setAddedElementToEdit(commit, state);
}
 ...
 * 添加单行输入控件
 */
export const addInputElement = ({commit, state}, data) => {
	commit(types.ADD_ELEMENT, new Input(data))
	setAddedElementToEdit(commit, state);
}
 ...
 * 添加多行输入控件
 */
export const addTextareaElement = ({commit, state}, data) => {
	commit(types.ADD_ELEMENT, new Textarea(data))
	setAddedElementToEdit(commit, state);
}
 ...
 * 添加按钮控件
 */
export const addButtonElement = ({commit, state}, data) => {
	commit(types.ADD_ELEMENT, new Button(data))
	setAddedElementToEdit(commit, state);
}
