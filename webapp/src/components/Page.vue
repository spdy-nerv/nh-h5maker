  ...
  <div :class="[type!=='see'?'canvas':'']"  @click="cleanSelected">
    <template v-for="element in elements">
      ...
      <div @click.stop="selectedElement(element)">
				<TitleElement v-if="element.type == 'title'" :element="element"></TitleElement>
				<InputElement v-if="element.type == 'input'" :element="element"></InputElement>
				<TextareaElement v-if="element.type == 'textarea'" :element="element"></TextareaElement>
				<ButtonElement v-if="element.type == 'button'" :element="element"></ButtonElement>
...
<script>
  ...
  import TextareaElement from './Element/TextareaElement'
  ...
  export default {
    ...
    components: {
      PicElement, FontElement, ShapesElement, TitleElement, InputElement, TextareaElement, ButtonElement
    }
  }
