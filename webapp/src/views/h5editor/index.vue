...
<script>
  ...
  export default {
    ...
    components: {
      Overview, CompSelector, CompConfig, Page, PicPicker, appConst, PreView, HeaderEdit, EditPanel, SvgPanel, ImgPanel
    },
    mounted () {
